...
<div class="card">
    <h5 class="card-header">Modifier le Catalogue</h5>
    <div class="card-body">
      <form method="post" action="{{route('catalog.update',$catalog->id)}}" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="title" placeholder="Entrer le titre"  value="{{$catalog->title}}" class="form-control">
          @error('title')
