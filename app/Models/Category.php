...
{
    protected $fillable=['title','slug','summary','description','photo','status','is_parent','parent_id','added_by','duree', 'niveau', 'langue', 'place','whatsapp'];

    public function parent_info(){
        return $this->hasOne('App\Models\Category','id','parent_id');
    }
    public static function getAllCategory(){
        return  Category::orderBy('id','DESC')->with('parent_info')->paginate(14);
    }
