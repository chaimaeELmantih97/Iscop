(function ($) {
    ...
    /*------------------------------------------
        = PARTNERS SLIDER
    -------------------------------------------*/
    if ($(".service-info-slider").length) {
        $(".service-info-slider").owlCarousel({
            autoplay: true,
            smartSpeed: 1200,
            margin: 30,
            loop: true,
            ...
            nav: true,
            navText: ['<i class="ti-angle-left"></i> <span>Précédent</span>', '<span>Suivant</span> <i class="ti-angle-right"></i>'],
            dots: false,
            responsive: {
                0: {
                    items: 1
